...
<head>
	<link rel="stylesheet" href="style.css"> 
        ...
        <form action="reset_pwd.php" method="POST"><br>
				...
				<input type="submit"  value="submit" name="fpwd"><br><br>
        <form>
</html>
                ...
                if($eml)
                {
                    if ($usr[4] != $pwd)
                    {
                        $email_cont = "Camagru change password";
                            ...
                            $content = "Hey  <br> We have noticed that you requested to change you password <br>
                                        <br><br>
...
{
    echo "please enter the desired fields";
}
?>
